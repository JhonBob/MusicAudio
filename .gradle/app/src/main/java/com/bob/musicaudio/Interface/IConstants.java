...
public interface IConstants {
    public static final String BROADCAST_NAME = "com.bob.musicaudio.broadcast";
    public static final String SERVICE_NAME = "com.bob.musicaudio.service.MediaService";
    public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.bob.musicaudio.querycomplete.broadcast";
    public static final String BROADCAST_CHANGEBG = "com.bob.musicaudio.changebg";
    public static final String BROADCAST_SHAKE = "com.bob.musicaudio.shake";

    //是否开启了振动模式
    public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";

    public static final String SP_NAME = "com.bob.musicaudio.music_preference";
